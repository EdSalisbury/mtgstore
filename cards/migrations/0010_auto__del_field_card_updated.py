...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Card.updated'
        db.delete_column(u'cards_card', 'updated')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Card.updated'
        raise RuntimeError("Cannot reverse this migration. 'Card.updated' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Card.updated'
        db.add_column(u'cards_card', 'updated',
