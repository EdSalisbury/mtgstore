...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cards_edition', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Edition.name'
        db.alter_column(u'cards_edition', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
