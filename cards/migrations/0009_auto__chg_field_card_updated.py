...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.updated'
        db.alter_column(u'cards_card', 'updated', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Card.updated'
        db.alter_column(u'cards_card', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
