...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.updated'
        db.add_column(u'cards_card', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2014, 6, 13, 0, 0), blank=True),
                      keep_default=False)
