...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.ebay_price'
        db.add_column(u'cards_card', 'ebay_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Card.ebay_item_id'
        db.add_column(u'cards_card', 'ebay_item_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Card.ebay_price'
        db.delete_column(u'cards_card', 'ebay_price')

        # Deleting field 'Card.ebay_item_id'
        db.delete_column(u'cards_card', 'ebay_item_id')
